...
ccc <- mutate(ccc, marker_color = ifelse(size_cat == 0, "gray75", "dodgerblue"))
...
write.csv(ccc, "c:/users/ulfel/documents/israel-protest-dashboard/data/israel_dashboard_data.csv", row.names = FALSE)
