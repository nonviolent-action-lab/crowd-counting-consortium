...
dat <- read_excel("data_raw/Crowd Estimates May 2020.xlsx", sheet = "Tally")
...
dat <- read_excel("data_raw/Crowd Estimates May 2020.xlsx", sheet = "Antiracism")
...
write.csv(dat, "data_clean/ccc_2020_05.csv", row.names = FALSE)
