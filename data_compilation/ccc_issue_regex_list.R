ccc_issue_regex_list <- list(
  ...
  guns = "(?<!water|bb )\\bguns?\\b|firearm|(?:second|2nd) amendment|\\b2a\\b|\\bnra\\b|national rifle association|concealed carry|open.carry|ar-15|ak-47|(?:assault|automatic) rifle|bump stock|right to bear arms|(?:school|mass) shooting|\\bbullets\\b",
