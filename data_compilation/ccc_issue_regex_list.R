ccc_issue_regex_list <- list(
  ...
  democracy = "democracy|voter|voting rights|election|ballot|redistrict|gerrymander|\\bfascis.|\\bmarxis.|\\bcommunis.|anarchis.|socialis.|\\bcoup\\b|dc statehood|Trump won|Project 2025|Agenda 47",
  ...
  education = "\\beducat(?:ion|or)|school|learning|student|pupil|\\bteach|faculty|universit(?:y|ies)|college|professor|principal|superintendent|classroom|\\bed\\b|campus|alumn|\\bpta\\b|\\btuition|betsy devos|scholasticide|academic",
  ...
  patriotism = "patriot(?! missile)|(?<!upside.down )american flag",
  ...
  religion = "religio|evangeli|\\bgod\\b|\\bjesus\\b|\\ballah|\\bchrist(ian)?\\b|catholic|protestant|presbyterian|baptist|islam|muslim|buddhis|sikh|\\bhindu\\b|\\bjew(?:ish|s)?\\b|semiti|mormon|church|synagogue|temple|mosque|\\bsharia\\b|pray(er)?|zionis.|judaism|hijab|pastor|reverend|priest|cleric|\\bimams?\\b|\\brabbis?\\b|\\bmonks?\\b|worship|\\bsatan(?:ic|is.)?\\b|secular|atheis.|\\bpagan(is)?|\\bfaith\\b|appeal to heaven|bible|rosar(?:y|ies)|theo(?:logy|cracy)|christo.?fascis|mennonite|jesuit",
